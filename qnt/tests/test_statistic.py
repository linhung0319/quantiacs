...
EXPECTED_JSON_SCHEMA = {
    "base": {"fields": [{"name": "time", "type": "datetime"}, {"name": "BTC", "type": "number"}],
             "primaryKey": ["time"], "pandas_version": "1.4.0"},
...
class TestBaseStatistic(unittest.TestCase):
    ...
    def test_relative_return_no_liquid(self):
        ...
        portfolio_history = qnstats.output_normalize(is_liquid, per_asset=False)
        rr_df, stat_head = get_rr_dataframe_and_json(data, portfolio_history)
        self.assertEqual({'data': [{'time': '2021-02-11T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-12T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-13T00:00:00.000', 'values': 0.0666666667},
                                   {'time': '2021-02-14T00:00:00.000', 'values': 0.0625},
                                   {'time': '2021-02-15T00:00:00.000', 'values': 0.0588235294},
                                   {'time': '2021-02-16T00:00:00.000', 'values': 0.0555555556},
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.05}],
                          'schema': EXPECTED_JSON_SCHEMA['base_values']}, stat_head)

        is_liquid.loc[dict(time='2021-02-15T00:00:00.000', asset='BTC')] = 0
        ...
        self.assertEqual({'data': [{'time': '2021-02-11T00:00:00.000', 'values': 0.0},
                                   ...
                                   {'time': '2021-02-14T00:00:00.000', 'values': 0.0625},
                                   {'time': '2021-02-15T00:00:00.000', 'values': 0.0588235294},
                                   {'time': '2021-02-16T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.05}],
                          'schema': EXPECTED_JSON_SCHEMA['base_values']}, stat_head)
    ...
    def test_relative_return_NaN(self):
        ...
        self.assertEqual({'data': [{'time': '2021-02-11T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-12T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-13T00:00:00.000', 'values': 0.0666666667},
                                   {'time': '2021-02-14T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-15T00:00:00.000', 'values': -0.0625},
                                   {'time': '2021-02-16T00:00:00.000', 'values': 0.0555555556},
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.0}],
                          'schema': EXPECTED_JSON_SCHEMA['base_values']}, stat_head)
        ...
        self.assertEqual({'data': [{'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-11T00:00:00.000'},
                                   {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-12T00:00:00.000'},
                                   {'BTC': 0.0666666667,
                                    'ETH': 0.0666666667,
                                    'time': '2021-02-13T00:00:00.000'},
                                   {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-14T00:00:00.000'},
                                   {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-15T00:00:00.000'},
                                   {'BTC': 0.1875, 'ETH': 0.1875, 'time': '2021-02-16T00:00:00.000'},
                                   {'BTC': 0.0526315789,
                                    'ETH': 0.0526315789,
                                    'time': '2021-02-17T00:00:00.000'},
                                   {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-18T00:00:00.000'}],
    ...
    def test_relative_return_NaN_one(self):
        ...
        self.assertEqual({'data': [{'BTC': 0.0, 'time': '2021-02-11T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-12T00:00:00.000'},
                                   {'BTC': 0.0666666667, 'time': '2021-02-13T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-14T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-15T00:00:00.000'},
                                   {'BTC': 0.1875, 'time': '2021-02-16T00:00:00.000'},
                                   {'BTC': 0.0526315789, 'time': '2021-02-17T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-18T00:00:00.000'}],
                          'schema': {'fields': [{'name': 'time', 'type': 'datetime'},
                                                {'name': 'BTC', 'type': 'number'}],
                                     'pandas_version': '1.4.0',
                                     'primaryKey': ['time']}}, stat_head)
    ...
    def test_relative_return_complex(self):
        ...
        data.loc[dict(time='2021-02-15T00:00:00.000', asset='BTC', field='open')] = 4
        ...
        self.assertEqual({'data': [{'time': '2021-02-11T00:00:00.000', 'values': 0.0},
                                   ...
                                   {'time': '2021-02-13T00:00:00.000', 'values': 0.0666666667},
                                   {'time': '2021-02-14T00:00:00.000', 'values': 0.0625},
                                   {'time': '2021-02-15T00:00:00.000', 'values': -0.5709342561},
                                   {'time': '2021-02-16T00:00:00.000', 'values': 0.0555555556},
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.05}],
                          'schema': EXPECTED_JSON_SCHEMA['base_values']}, stat_head)
    ...
    def test_relative_return_one(self):
        ...
        self.assertEqual({'data': [{'BTC': 0.0, 'time': '2021-02-11T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-12T00:00:00.000'},
                                   {'BTC': 0.0666666667, 'time': '2021-02-13T00:00:00.000'},
                                   {'BTC': 0.0625, 'time': '2021-02-14T00:00:00.000'},
                                   {'BTC': 0.0588235294, 'time': '2021-02-15T00:00:00.000'},
                                   {'BTC': 0.0555555556, 'time': '2021-02-16T00:00:00.000'},
                                   {'BTC': 0.0526315789, 'time': '2021-02-17T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-02-18T00:00:00.000'}],
                          'schema': {'fields': [{'name': 'time', 'type': 'datetime'},
                                                {'name': 'BTC', 'type': 'number'}],
                                     'pandas_version': '1.4.0',
                                     'primaryKey': ['time']}}, stat_head)
        ...
        self.assertEqual({'data': [{'time': '2021-02-12T00:00:00.000', 'values': 0.0},
                                   ...
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.05},
                                   {'time': '2021-02-19T00:00:00.000', 'values': 0.0476190476}],
                          'schema': EXPECTED_JSON_SCHEMA['base_values']}, stat_head)
    ...
    def test_relative_return_one_border_case(self):
        ...
        data.loc[dict(time='2021-02-14T00:00:00.000', field='open')] = 15
        data.loc[dict(time='2021-02-14T00:00:00.000', field='close')] = 16
        data.loc[dict(time='2021-02-14T00:00:00.000', field='low')] = 15
        data.loc[dict(time='2021-02-14T00:00:00.000', field='high')] = 16

        data.loc[dict(time='2021-02-15T00:00:00.000', field='open')] = 15
        data.loc[dict(time='2021-02-15T00:00:00.000', field='close')] = 16
        data.loc[dict(time='2021-02-15T00:00:00.000', field='low')] = 15
        data.loc[dict(time='2021-02-15T00:00:00.000', field='high')] = 16
        #
        # {"time": "2021-02-13T00:00:00.000", "open": 15, "close": 16, "low": 15, "high": 16, "vol": 1000, "divs": 0,
        #  "split": 0, "split_cumprod": 0, "is_liquid": 1},
        # {"time": "2021-02-14T00:00:00.000", "open": 15, "close": 16, "low": 15, "high": 16, "vol": 1000, "divs": 0,
        #  "split": 0, "split_cumprod": 0, "is_liquid": 1},
        # {"time": "2021-02-15T00:00:00.000", "open": 15, "close": 16, "low": 15, "high": 16, "vol": 1000, "divs": 0,
        #  "split": 0, "split_cumprod": 0, "is_liquid": 1},
        # {"time": "2021-02-16T00:00:00.000", "open": 18, "close": 19, "low": 18, "high": 19, "vol": 1000, "divs": 0,
        #  "split": 0, "split_cumprod": 0, "is_liquid": 1},
        ...
        self.assertEqual({'data': [{'BTC': 0.0, 'time': '2021-02-11T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-12T00:00:00.000'},
                                   {'BTC': 0.0666666667, 'time': '2021-02-13T00:00:00.000'},
                                   {'BTC': -0.00390625, 'time': '2021-02-14T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-15T00:00:00.000'},
                                   {'BTC': 0.1797385621, 'time': '2021-02-16T00:00:00.000'},
                                   {'BTC': 0.0526315789, 'time': '2021-02-17T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-02-18T00:00:00.000'}],
                          'schema': {'fields': [{'name': 'time', 'type': 'datetime'},
                                                {'name': 'BTC', 'type': 'number'}],
        ...
        self.assertEqual({'data': [{'time': '2021-02-11T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-12T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-13T00:00:00.000', 'values': 0.0666666667},
                                   {'time': '2021-02-14T00:00:00.000', 'values': -0.00390625},
                                   {'time': '2021-02-15T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-16T00:00:00.000', 'values': 0.1797385621},
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.05}],
                          'schema': EXPECTED_JSON_SCHEMA['base_values']}, stat_head)

        data.loc[dict(time='2021-02-14T00:00:00.000', field='open')] = 18
        data.loc[dict(time='2021-02-14T00:00:00.000', field='close')] = 19
        data.loc[dict(time='2021-02-14T00:00:00.000', field='low')] = 18
        data.loc[dict(time='2021-02-14T00:00:00.000', field='high')] = 19

        data.loc[dict(time='2021-02-15T00:00:00.000', field='open')] = 18
        data.loc[dict(time='2021-02-15T00:00:00.000', field='close')] = 19
        data.loc[dict(time='2021-02-15T00:00:00.000', field='low')] = 18
        data.loc[dict(time='2021-02-15T00:00:00.000', field='high')] = 19
        ...
        self.assertEqual({'data': [{'time': '2021-02-11T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-12T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-13T00:00:00.000', 'values': 0.0666666667},
                                   {'time': '2021-02-14T00:00:00.000', 'values': 0.1875},
                                   {'time': '2021-02-15T00:00:00.000', 'values': -0.0027700831},
                                   {'time': '2021-02-16T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.05}],
                          'schema': EXPECTED_JSON_SCHEMA['base_values']}, stat_head)
        ...
        self.assertEqual({'data': [{'BTC': 0.0, 'time': '2021-02-11T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-12T00:00:00.000'},
                                   {'BTC': 0.0666666667, 'time': '2021-02-13T00:00:00.000'},
                                   {'BTC': 0.1875, 'time': '2021-02-14T00:00:00.000'},
                                   {'BTC': -0.0027700831, 'time': '2021-02-15T00:00:00.000'},
                                   {'BTC': 0.0, 'time': '2021-02-16T00:00:00.000'},
                                   {'BTC': 0.0526315789, 'time': '2021-02-17T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-02-18T00:00:00.000'}],
                          'schema': {'fields': [{'name': 'time', 'type': 'datetime'},
                                                {'name': 'BTC', 'type': 'number'}],
    ...
    def test_relative_return_two(self):
        ...
        self.assertEqual({'data': [{'time': '2021-02-11T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-12T00:00:00.000', 'values': 0.0},
                                   {'time': '2021-02-13T00:00:00.000', 'values': 0.0666666667},
                                   {'time': '2021-02-14T00:00:00.000', 'values': 0.0546875},
                                   {'time': '2021-02-15T00:00:00.000', 'values': 0.0588235294},
                                   {'time': '2021-02-16T00:00:00.000', 'values': 0.0555555556},
                                   {'time': '2021-02-17T00:00:00.000', 'values': 0.0526315789},
                                   {'time': '2021-02-18T00:00:00.000', 'values': 0.05}],
        ...
        self.assertEqual({'data': [{'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-11T00:00:00.000'},
                                   ...
                                   {'BTC': 0.0546875,
                                    'ETH': 0.0546875,
                                    'time': '2021-02-14T00:00:00.000'},
                                   {'BTC': 0.0588235294,
                                    'ETH': 0.0588235294,
                                    'time': '2021-02-15T00:00:00.000'},
                                   {'BTC': 0.0555555556,
                                    'ETH': 0.0555555556,
                                    'time': '2021-02-16T00:00:00.000'},
                                   {'BTC': 0.0526315789,
                                    'ETH': 0.0526315789,
                                    'time': '2021-02-17T00:00:00.000'},
                                   {'BTC': 0.05, 'ETH': 0.05, 'time': '2021-02-18T00:00:00.000'}],
                          'schema': {'fields': [{'name': 'time', 'type': 'datetime'},
                                                {'name': 'BTC', 'type': 'number'},
                                                {'name': 'ETH', 'type': 'number'}],
                                     'pandas_version': '1.4.0',
    ...
    def test_slippage_factor(self):
        ...
        self.assertEqual({'data': [{'BTC': None, 'time': '2021-01-30T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-01-31T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-02-01T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-02-02T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-02-03T00:00:00.000'}],
                          'schema': EXPECTED_JSON_SCHEMA['base']}, r)

        data.loc[dict(time='2021-01-31T00:00:00.000', asset='BTC', field='close')] = 4
        data.loc[dict(time='2021-01-31T00:00:00.000', asset='BTC', field='high')] = 4

        r = get_slippage_json(data, 3)

        self.assertEqual({'data': [{'BTC': None, 'time': '2021-01-30T00:00:00.000'},
                                   {'BTC': 0.1, 'time': '2021-01-31T00:00:00.000'},
                                   {'BTC': 0.05, 'time': '2021-02-01T00:00:00.000'}],
                          'schema': EXPECTED_JSON_SCHEMA['base']}, r)
    ...
    def test_relative_return(self):
        ...
        #           {'time': '2021-02-15T00:00:00.000', 'values': 0.0},
        #           {'time': '2021-02-16T00:00:00.000', 'values': 0.0},
        #           {'time': '2021-02-17T00:00:00.000', 'values': 0.0},
        #           {'time': '2021-02-18T00:00:00.000', 'values': 0.0},
        #           {'time': '2021-02-19T00:00:00.000', 'values': 0.0},
        ...
        self.assertEqual(
            {"schema": EXPECTED_JSON_SCHEMA["base_values"],
             "data": [{"time": "2021-01-30T00:00:00.000", "values": 0.0},
                      {"time": "2021-01-31T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-01T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-02T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-03T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-04T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-05T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-06T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-07T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-08T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-09T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-10T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-11T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-12T00:00:00.000", "values": 0.0},
                      {"time": "2021-02-13T00:00:00.000", "values": 0.0666666667},
                      {"time": "2021-02-14T00:00:00.000", "values": 0.0625},
                      {"time": "2021-02-15T00:00:00.000", "values": 0.0588235294},
                      ...
                      {"time": "2021-02-18T00:00:00.000", "values": 0.05},
                      {"time": "2021-02-19T00:00:00.000", "values": 0.0476190476},
                      {"time": "2021-02-20T00:00:00.000", "values": 0.0454545455},
                      {"time": "2021-02-21T00:00:00.000", "values": 0.0434782609},
                      {"time": "2021-02-22T00:00:00.000", "values": 0.0416666667},
                      {"time": "2021-02-23T00:00:00.000", "values": 0.04},
                      {"time": "2021-02-24T00:00:00.000", "values": 0.0384615385},
                      {"time": "2021-02-25T00:00:00.000", "values": 0.037037037},
                      {"time": "2021-02-26T00:00:00.000", "values": 0.0357142857},
                      {"time": "2021-02-27T00:00:00.000", "values": 0.0344827586},
                      {"time": "2021-02-28T00:00:00.000", "values": 0.0333333333},
                      {"time": "2021-03-01T00:00:00.000", "values": 0.0322580645},
                      {"time": "2021-03-02T00:00:00.000", "values": 0.03125},
                      {"time": "2021-03-03T00:00:00.000", "values": 0.0303030303},
                      {"time": "2021-03-04T00:00:00.000", "values": 0.0294117647},
                      {"time": "2021-03-05T00:00:00.000", "values": 0.0285714286},
                      {"time": "2021-03-06T00:00:00.000", "values": 0.0277777778},
                      {"time": "2021-03-07T00:00:00.000", "values": 0.027027027},
                      {"time": "2021-03-08T00:00:00.000", "values": 0.0263157895},
                      {"time": "2021-03-09T00:00:00.000", "values": 0.0256410256},
                      {"time": "2021-03-10T00:00:00.000", "values": 0.025},
                      {"time": "2021-03-11T00:00:00.000", "values": 0.0243902439},
                      {"time": "2021-03-12T00:00:00.000", "values": 0.0238095238},
                      {"time": "2021-03-13T00:00:00.000", "values": 0.023255814},
                      {"time": "2021-03-14T00:00:00.000", "values": 0.0227272727},
                      {"time": "2021-03-15T00:00:00.000", "values": 0.0222222222},
                      {"time": "2021-03-16T00:00:00.000", "values": 0.0217391304},
                      {"time": "2021-03-17T00:00:00.000", "values": 0.0212765957},
                      {"time": "2021-03-18T00:00:00.000", "values": 0.0208333333},
                      {"time": "2021-03-19T00:00:00.000", "values": 0.0204081633},
                      {"time": "2021-03-20T00:00:00.000", "values": 0.02},
                      {"time": "2021-03-21T00:00:00.000", "values": 0.0196078431},
                      {"time": "2021-03-22T00:00:00.000", "values": 0.0192307692},
                      {"time": "2021-03-23T00:00:00.000", "values": 0.0188679245},
                      {"time": "2021-03-24T00:00:00.000", "values": 0.0185185185},
                      {"time": "2021-03-25T00:00:00.000", "values": 0.0181818182},
                      {"time": "2021-03-26T00:00:00.000", "values": 0.0178571429},
                      {"time": "2021-03-27T00:00:00.000", "values": 0.0175438596},
                      {"time": "2021-03-28T00:00:00.000", "values": 0.0172413793},
                      {"time": "2021-03-29T00:00:00.000", "values": 0.0169491525},
                      {"time": "2021-03-30T00:00:00.000", "values": 0.0166666667},
                      {"time": "2021-03-31T00:00:00.000", "values": 0.0163934426},
                      {"time": "2021-04-01T00:00:00.000", "values": 0.0161290323},
                      {"time": "2021-04-02T00:00:00.000", "values": 0.0158730159},
                      {"time": "2021-04-03T00:00:00.000", "values": 0.015625},
                      {"time": "2021-04-04T00:00:00.000", "values": 0.0153846154},
                      {"time": "2021-04-05T00:00:00.000", "values": 0.0151515152},
                      {"time": "2021-04-06T00:00:00.000", "values": 0.0149253731},
                      {"time": "2021-04-07T00:00:00.000", "values": 0.0147058824},
                      {"time": "2021-04-08T00:00:00.000", "values": 0.0144927536},
                      {"time": "2021-04-09T00:00:00.000", "values": 0.0142857143},
                      {"time": "2021-04-10T00:00:00.000", "values": 0.014084507},
                      {"time": "2021-04-11T00:00:00.000", "values": 0.0138888889},
                      {"time": "2021-04-12T00:00:00.000", "values": 0.0136986301},
                      {"time": "2021-04-13T00:00:00.000", "values": 0.0135135135},
                      {"time": "2021-04-14T00:00:00.000", "values": 0.0133333333},
                      {"time": "2021-04-15T00:00:00.000", "values": 0.0131578947},
                      {"time": "2021-04-16T00:00:00.000", "values": 0.012987013},
                      {"time": "2021-04-17T00:00:00.000", "values": 0.0128205128},
                      {"time": "2021-04-18T00:00:00.000", "values": 0.0126582278},
                      {"time": "2021-04-19T00:00:00.000", "values": 0.0125},
                      {"time": "2021-04-20T00:00:00.000", "values": 0.012345679},
                      {"time": "2021-04-21T00:00:00.000", "values": 0.012195122},
                      {"time": "2021-04-22T00:00:00.000", "values": 0.0120481928},
                      {"time": "2021-04-23T00:00:00.000", "values": 0.0119047619},
                      {"time": "2021-04-24T00:00:00.000", "values": 0.0117647059},
                      {"time": "2021-04-25T00:00:00.000", "values": 0.011627907},
                      {"time": "2021-04-26T00:00:00.000", "values": 0.0114942529},
                      {"time": "2021-04-27T00:00:00.000", "values": 0.0113636364},
                      {"time": "2021-04-28T00:00:00.000", "values": 0.0112359551},
                      {"time": "2021-04-29T00:00:00.000", "values": 0.0111111111},
                      {"time": "2021-04-30T00:00:00.000", "values": 0.010989011},
                      {"time": "2021-05-01T00:00:00.000", "values": 0.0108695652},
                      {"time": "2021-05-02T00:00:00.000", "values": 0.0107526882},
                      {"time": "2021-05-03T00:00:00.000", "values": 0.0106382979},
                      {"time": "2021-05-04T00:00:00.000", "values": 0.0105263158},
                      {"time": "2021-05-05T00:00:00.000", "values": 0.0104166667},
                      {"time": "2021-05-06T00:00:00.000", "values": 0.0103092784},
                      {"time": "2021-05-07T00:00:00.000", "values": 0.0102040816},
                      {"time": "2021-05-08T00:00:00.000", "values": 0.0101010101},
                      {"time": "2021-05-09T00:00:00.000", "values": 0.01}]}, stat_head)
    ...
    def test_relative_return_per_asset(self):
        # this code demonstrates the problem of calculating if nan is found in the sample
        #  {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-13T00:00:00.000'},
        #           {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-14T00:00:00.000'},
        #           {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-15T00:00:00.000'},
        #           {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-16T00:00:00.000'},
        #           {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-17T00:00:00.000'},
        #           {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-18T00:00:00.000'},
        #           {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-19T00:00:00.000'},
        ...
        stat_head = json.loads(rr_df.to_json(orient="table"))
        self.assertEqual(
            {'data': [{'BTC': 0.0, 'ETH': 0.0, 'time': '2021-01-30T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-01-31T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-01T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-02T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-03T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-04T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-05T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-06T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-07T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-08T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-09T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-10T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-11T00:00:00.000'},
                      {'BTC': 0.0, 'ETH': 0.0, 'time': '2021-02-12T00:00:00.000'},
                      {'BTC': 0.0333333333,
                       'ETH': 0.0333333333,
                       'time': '2021-02-13T00:00:00.000'},
                      {'BTC': 0.03125, 'ETH': 0.03125, 'time': '2021-02-14T00:00:00.000'},
                      {'BTC': 0.0294117647,
                       'ETH': 0.0294117647,
                       'time': '2021-02-15T00:00:00.000'},
                      {'BTC': 0.0277777778,
                      ...
                      {'BTC': 0.0263157895,
                       'ETH': 0.0263157895,
                       'time': '2021-02-17T00:00:00.000'},
                      {'BTC': 0.025, 'ETH': 0.025, 'time': '2021-02-18T00:00:00.000'},
                      {'BTC': 0.0238095238,
                       'ETH': 0.0238095238,
                       'time': '2021-02-19T00:00:00.000'},
                      {'BTC': 0.0227272727,
                       'ETH': 0.0227272727,
                       'time': '2021-02-20T00:00:00.000'},
                      {'BTC': 0.0217391304,
                       'ETH': 0.0217391304,
                       'time': '2021-02-21T00:00:00.000'},
                      {'BTC': 0.0208333333,
                       'ETH': 0.0208333333,
                       'time': '2021-02-22T00:00:00.000'},
                      {'BTC': 0.02, 'ETH': 0.02, 'time': '2021-02-23T00:00:00.000'},
                      {'BTC': 0.0192307692,
                       'ETH': 0.0192307692,
                       'time': '2021-02-24T00:00:00.000'},
                      {'BTC': 0.0185185185,
                       'ETH': 0.0185185185,
                       'time': '2021-02-25T00:00:00.000'},
                      {'BTC': 0.0178571429,
                       'ETH': 0.0178571429,
                       'time': '2021-02-26T00:00:00.000'},
                      {'BTC': 0.0172413793,
                       'ETH': 0.0172413793,
                       'time': '2021-02-27T00:00:00.000'}],
             'schema': {'fields': [{'name': 'time', 'type': 'datetime'},
                                   {'name': 'BTC', 'type': 'number'},
                                   {'name': 'ETH', 'type': 'number'}],
                        'pandas_version': '1.4.0',
